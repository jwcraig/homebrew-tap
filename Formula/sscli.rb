...
class Sscli < Formula
  ...
  on_macos do
    on_intel do
      url "https://github.com/jwcraig/sql-server-cli/releases/download/v0.1.9/sscli-x86_64-apple-darwin.tar.gz"
      sha256 "bd952e78119179763989e2ef09160d08dfba85b69b1eea94f5a264b4f9a43d7f"
    end
    on_arm do

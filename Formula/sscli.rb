...
class Sscli < Formula
  ...
  on_macos do
    on_intel do
      url "https://github.com/jwcraig/sql-server-cli/releases/download/v0.1.10/sscli-x86_64-apple-darwin.tar.gz"
      sha256 "8edc8487008855a5a301695636c05d150c32ec7b24334b2b322c5f6526d8f407"
    end
    on_arm do
